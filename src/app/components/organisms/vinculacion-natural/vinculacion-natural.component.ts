...
export class VinculacionNaturalComponent {
  ...
  constructor(private fb: FormBuilder) {
    ...
    this.naturalForm = this.fb.group({
      ...
      suffers_illness: new FormControl('', [Validators.required]),
      illnesses: new FormControl('', [Validators.required]),
      takes_medicine: new FormControl('', [Validators.required]),
      medicines: new FormControl('', [Validators.required]),
      suffers_phobias: new FormControl('', [Validators.required]),
      phobias: new FormControl('', [Validators.required]),
      suffers_allergies: new FormControl('', [Validators.required]),
      allergies: new FormControl('', [Validators.required]),
      has_food_restrictions: new FormControl('', [Validators.required]),
      ...
      accountant_name: new FormControl('', [Validators.required]),
